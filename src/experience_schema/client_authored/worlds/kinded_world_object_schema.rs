use crate::client_authored::worlds::hotspot_object_schemas::{
    HotspotMarkerSpriteObjectSchema, InteractableHotspotObjectSchema,
    TransitionHotspotObjectSchema,
};
...
impl KindedWorldObjectSchema {
    pub fn canonical_object_type_name(&self) -> &str {
        match self {
            ...
            Self::InteractableHotspot(interactable_hotspot) => interactable_hotspot.object_type.as_str(),
